...
const (
	...
	AuthService_AuthorizeInternal_FullMethodName  = "/recruitment.AuthService/AuthorizeInternal"
...
type AuthServiceClient interface {
	...
	AuthorizeInternal(ctx context.Context, in *AuthorizeInternalRequest, opts ...grpc.CallOption) (*AuthorizeInternalResponse, error)
...
func (c *authServiceClient) AuthorizeInternal(ctx context.Context, in *AuthorizeInternalRequest, opts ...grpc.CallOption) (*AuthorizeInternalResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthorizeInternalResponse)
	err := c.cc.Invoke(ctx, AuthService_AuthorizeInternal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	AuthorizeInternal(context.Context, *AuthorizeInternalRequest) (*AuthorizeInternalResponse, error)
...
func (UnimplementedAuthServiceServer) AuthorizeInternal(context.Context, *AuthorizeInternalRequest) (*AuthorizeInternalResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AuthorizeInternal not implemented")
}
...
func _AuthService_AuthorizeInternal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuthorizeInternalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).AuthorizeInternal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_AuthorizeInternal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).AuthorizeInternal(ctx, req.(*AuthorizeInternalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_AuthorizeInternal_Handler,
		},
		{
...
const (
	ApplicationOwnerService_GetApplicationSnapshot_FullMethodName              = "/recruitment.ApplicationOwnerService/GetApplicationSnapshot"
	ApplicationOwnerService_ApplyApplicationLifecycleTransition_FullMethodName = "/recruitment.ApplicationOwnerService/ApplyApplicationLifecycleTransition"
)

// ApplicationOwnerServiceClient is the client API for ApplicationOwnerService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type ApplicationOwnerServiceClient interface {
	GetApplicationSnapshot(ctx context.Context, in *GetApplicationSnapshotRequest, opts ...grpc.CallOption) (*GetApplicationSnapshotResponse, error)
	ApplyApplicationLifecycleTransition(ctx context.Context, in *ApplyApplicationLifecycleTransitionRequest, opts ...grpc.CallOption) (*ApplyApplicationLifecycleTransitionResponse, error)
}

type applicationOwnerServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewApplicationOwnerServiceClient(cc grpc.ClientConnInterface) ApplicationOwnerServiceClient {
	return &applicationOwnerServiceClient{cc}
}

func (c *applicationOwnerServiceClient) GetApplicationSnapshot(ctx context.Context, in *GetApplicationSnapshotRequest, opts ...grpc.CallOption) (*GetApplicationSnapshotResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetApplicationSnapshotResponse)
	err := c.cc.Invoke(ctx, ApplicationOwnerService_GetApplicationSnapshot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *applicationOwnerServiceClient) ApplyApplicationLifecycleTransition(ctx context.Context, in *ApplyApplicationLifecycleTransitionRequest, opts ...grpc.CallOption) (*ApplyApplicationLifecycleTransitionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ApplyApplicationLifecycleTransitionResponse)
	err := c.cc.Invoke(ctx, ApplicationOwnerService_ApplyApplicationLifecycleTransition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// ApplicationOwnerServiceServer is the server API for ApplicationOwnerService service.
// All implementations must embed UnimplementedApplicationOwnerServiceServer
// for forward compatibility.
type ApplicationOwnerServiceServer interface {
	GetApplicationSnapshot(context.Context, *GetApplicationSnapshotRequest) (*GetApplicationSnapshotResponse, error)
	ApplyApplicationLifecycleTransition(context.Context, *ApplyApplicationLifecycleTransitionRequest) (*ApplyApplicationLifecycleTransitionResponse, error)
	mustEmbedUnimplementedApplicationOwnerServiceServer()
}

// UnimplementedApplicationOwnerServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
type UnimplementedApplicationOwnerServiceServer struct{}

func (UnimplementedApplicationOwnerServiceServer) GetApplicationSnapshot(context.Context, *GetApplicationSnapshotRequest) (*GetApplicationSnapshotResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetApplicationSnapshot not implemented")
}
func (UnimplementedApplicationOwnerServiceServer) ApplyApplicationLifecycleTransition(context.Context, *ApplyApplicationLifecycleTransitionRequest) (*ApplyApplicationLifecycleTransitionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ApplyApplicationLifecycleTransition not implemented")
}
func (UnimplementedApplicationOwnerServiceServer) mustEmbedUnimplementedApplicationOwnerServiceServer() {
}
func (UnimplementedApplicationOwnerServiceServer) testEmbeddedByValue() {}

// UnsafeApplicationOwnerServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to ApplicationOwnerServiceServer will
// result in compilation errors.
type UnsafeApplicationOwnerServiceServer interface {
	mustEmbedUnimplementedApplicationOwnerServiceServer()
}

func RegisterApplicationOwnerServiceServer(s grpc.ServiceRegistrar, srv ApplicationOwnerServiceServer) {
	// If the following call panics, it indicates UnimplementedApplicationOwnerServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
	...
	s.RegisterService(&ApplicationOwnerService_ServiceDesc, srv)
}

func _ApplicationOwnerService_GetApplicationSnapshot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetApplicationSnapshotRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApplicationOwnerServiceServer).GetApplicationSnapshot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApplicationOwnerService_GetApplicationSnapshot_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApplicationOwnerServiceServer).GetApplicationSnapshot(ctx, req.(*GetApplicationSnapshotRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApplicationOwnerService_ApplyApplicationLifecycleTransition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ApplyApplicationLifecycleTransitionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApplicationOwnerServiceServer).ApplyApplicationLifecycleTransition(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApplicationOwnerService_ApplyApplicationLifecycleTransition_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApplicationOwnerServiceServer).ApplyApplicationLifecycleTransition(ctx, req.(*ApplyApplicationLifecycleTransitionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// ApplicationOwnerService_ServiceDesc is the grpc.ServiceDesc for ApplicationOwnerService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var ApplicationOwnerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "recruitment.ApplicationOwnerService",
	HandlerType: (*ApplicationOwnerServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetApplicationSnapshot",
			Handler:    _ApplicationOwnerService_GetApplicationSnapshot_Handler,
		},
		{
			MethodName: "ApplyApplicationLifecycleTransition",
			Handler:    _ApplicationOwnerService_ApplyApplicationLifecycleTransition_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/recruitment.proto",
...
const (
	...
	AIService_CreateAgentRun_FullMethodName                   = "/recruitment.AIService/CreateAgentRun"
	AIService_GetAgentRun_FullMethodName                      = "/recruitment.AIService/GetAgentRun"
	AIService_GetActiveAgentRun_FullMethodName                = "/recruitment.AIService/GetActiveAgentRun"
...
type AIServiceClient interface {
	...
	// Durable resumable HR Agent runs (create/get/active/subscribe/cancel/confirm).
	// ChatStream remains available for rollout compatibility.
	...
	GetActiveAgentRun(ctx context.Context, in *GetActiveAgentRunRequest, opts ...grpc.CallOption) (*GetActiveAgentRunResponse, error)
...
func (c *aIServiceClient) CreateAgentRun(ctx context.Context, in *CreateAgentRunRequest, opts ...grpc.CallOption) (*CreateAgentRunResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateAgentRunResponse)
	err := c.cc.Invoke(ctx, AIService_CreateAgentRun_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aIServiceClient) GetAgentRun(ctx context.Context, in *GetAgentRunRequest, opts ...grpc.CallOption) (*GetAgentRunResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAgentRunResponse)
	err := c.cc.Invoke(ctx, AIService_GetAgentRun_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aIServiceClient) GetActiveAgentRun(ctx context.Context, in *GetActiveAgentRunRequest, opts ...grpc.CallOption) (*GetActiveAgentRunResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetActiveAgentRunResponse)
	err := c.cc.Invoke(ctx, AIService_GetActiveAgentRun_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aIServiceClient) SubscribeAgentRunEvents(ctx context.Context, in *SubscribeAgentRunEventsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AgentRunEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AIService_ServiceDesc.Streams[2], AIService_SubscribeAgentRunEvents_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeAgentRunEventsRequest, AgentRunEvent]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AIService_SubscribeAgentRunEventsClient = grpc.ServerStreamingClient[AgentRunEvent]

func (c *aIServiceClient) CancelAgentRun(ctx context.Context, in *CancelAgentRunRequest, opts ...grpc.CallOption) (*CancelAgentRunResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CancelAgentRunResponse)
	err := c.cc.Invoke(ctx, AIService_CancelAgentRun_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aIServiceClient) ConfirmAgentRun(ctx context.Context, in *ConfirmAgentRunRequest, opts ...grpc.CallOption) (*ConfirmAgentRunResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConfirmAgentRunResponse)
	err := c.cc.Invoke(ctx, AIService_ConfirmAgentRun_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AIServiceServer interface {
	...
	GetActiveAgentRun(context.Context, *GetActiveAgentRunRequest) (*GetActiveAgentRunResponse, error)
...
func (UnimplementedAIServiceServer) CreateAgentRun(context.Context, *CreateAgentRunRequest) (*CreateAgentRunResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateAgentRun not implemented")
}
func (UnimplementedAIServiceServer) GetAgentRun(context.Context, *GetAgentRunRequest) (*GetAgentRunResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAgentRun not implemented")
}
func (UnimplementedAIServiceServer) GetActiveAgentRun(context.Context, *GetActiveAgentRunRequest) (*GetActiveAgentRunResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetActiveAgentRun not implemented")
}
func (UnimplementedAIServiceServer) SubscribeAgentRunEvents(*SubscribeAgentRunEventsRequest, grpc.ServerStreamingServer[AgentRunEvent]) error {
	return status.Error(codes.Unimplemented, "method SubscribeAgentRunEvents not implemented")
}
func (UnimplementedAIServiceServer) CancelAgentRun(context.Context, *CancelAgentRunRequest) (*CancelAgentRunResponse, error) {
...
func _AIService_CreateAgentRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateAgentRunRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AIServiceServer).CreateAgentRun(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AIService_CreateAgentRun_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AIServiceServer).CreateAgentRun(ctx, req.(*CreateAgentRunRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AIService_GetAgentRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAgentRunRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AIServiceServer).GetAgentRun(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AIService_GetAgentRun_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AIServiceServer).GetAgentRun(ctx, req.(*GetAgentRunRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AIService_GetActiveAgentRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetActiveAgentRunRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AIServiceServer).GetActiveAgentRun(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AIService_GetActiveAgentRun_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AIServiceServer).GetActiveAgentRun(ctx, req.(*GetActiveAgentRunRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AIService_SubscribeAgentRunEvents_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(SubscribeAgentRunEventsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(AIServiceServer).SubscribeAgentRunEvents(m, &grpc.GenericServerStream[SubscribeAgentRunEventsRequest, AgentRunEvent]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AIService_SubscribeAgentRunEventsServer = grpc.ServerStreamingServer[AgentRunEvent]

func _AIService_CancelAgentRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CancelAgentRunRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AIServiceServer).CancelAgentRun(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AIService_CancelAgentRun_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AIServiceServer).CancelAgentRun(ctx, req.(*CancelAgentRunRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AIService_ConfirmAgentRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConfirmAgentRunRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AIServiceServer).ConfirmAgentRun(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AIService_ConfirmAgentRun_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AIServiceServer).ConfirmAgentRun(ctx, req.(*ConfirmAgentRunRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AIService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AIService_CreateAgentRun_Handler,
		},
		{
			MethodName: "GetAgentRun",
			Handler:    _AIService_GetAgentRun_Handler,
		},
		{
			MethodName: "GetActiveAgentRun",
			Handler:    _AIService_GetActiveAgentRun_Handler,
		},
		{
			MethodName: "CancelAgentRun",
			Handler:    _AIService_CancelAgentRun_Handler,
		},
		{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SubscribeAgentRunEvents",
			Handler:       _AIService_SubscribeAgentRunEvents_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "proto/recruitment.proto",

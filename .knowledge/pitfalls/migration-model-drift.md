...
This pitfall was verified from migration consistency tests, migration runner tests, GORM models, outbox/inbox/analytics projection migrations and repository tests, repository test helpers, the table ownership manifest/check script, and `db.sql` on 2026-07-12.

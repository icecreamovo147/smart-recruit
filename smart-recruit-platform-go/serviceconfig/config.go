...
func Load() (Config, error) {
	...
	if cfg.Logging.FilePath == "" {
		cfg.Logging.FilePath = "logs/smart-recruit-service.log"
	}
...
func applyEnvOverrides(cfg *Config) {
	...
	setString(&cfg.Observability.WorkerHealthAddr, "WORKER_HEALTH_ADDR")
	...
	setInt(&cfg.MCP.DefaultTimeoutSeconds, "MCP_DEFAULT_TIMEOUT_SECONDS")
	setInt(&cfg.MCP.DefaultMaxRetries, "MCP_DEFAULT_MAX_RETRIES")
	setBool(&cfg.MCP.AllowStdio, "MCP_ALLOW_STDIO")
	setStringSlice(&cfg.MCP.AllowedStdioCommands, "MCP_ALLOWED_STDIO_COMMANDS")
	setStringSlice(&cfg.MCP.AllowedURLHosts, "MCP_ALLOWED_URL_HOSTS")
	setBoolPtr(&cfg.MCP.BlockPrivateNetwork, "MCP_BLOCK_PRIVATE_NETWORK")
	setInt(&cfg.MCP.MaxTimeoutSeconds, "MCP_MAX_TIMEOUT_SECONDS")

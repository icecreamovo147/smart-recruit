...
func Setup(cfg config.Config, clients *rpc.Clients, rdb *redis.Client) (*gin.Engine, *middleware.LimiterRegistry) {
	...
	candidateMemoryHandler := candidate.NewMemoryHandler(clients)
	...
	candidateGroup.GET("/ai/memories", normalTimeout, middleware.RequirePermission(authz.PermAICandidateUse), candidateMemoryHandler.List)
	candidateGroup.GET("/ai/memories/:id", normalTimeout, middleware.RequirePermission(authz.PermAICandidateUse), candidateMemoryHandler.Get)
	candidateGroup.POST("/ai/memories", normalTimeout, bodyAI, middleware.RequirePermission(authz.PermAICandidateUse), candidateMemoryHandler.Create)
	candidateGroup.PUT("/ai/memories/:id", normalTimeout, bodyAI, middleware.RequirePermission(authz.PermAICandidateUse), candidateMemoryHandler.Update)
	candidateGroup.POST("/ai/memories/:id/revoke", normalTimeout, bodyAuth, middleware.RequirePermission(authz.PermAICandidateUse), candidateMemoryHandler.Revoke)
	...
	staffGroup.GET("/ai/memories", normalTimeout, middleware.RequirePermission(authz.PermAIHRUse), memoryHandler.List)
	staffGroup.GET("/ai/memories/:id", normalTimeout, middleware.RequirePermission(authz.PermAIHRUse), memoryHandler.Get)
	staffGroup.POST("/ai/memories", normalTimeout, bodyAI, middleware.RequirePermission(authz.PermAIHRUse), memoryHandler.Create)
	staffGroup.PUT("/ai/memories/:id", normalTimeout, bodyAI, middleware.RequirePermission(authz.PermAIHRUse), memoryHandler.Update)
	staffGroup.POST("/ai/memories/:id/revoke", normalTimeout, bodyAuth, middleware.RequirePermission(authz.PermAIHRUse), memoryHandler.Revoke)
	staffGroup.POST("/ai/memories/recall", normalTimeout, bodyAI, middleware.RequirePermission(authz.PermAIHRUse), memoryHandler.Recall)
	...
	platformAIGroup.POST("/memories", normalTimeout, bodyAdmin, middleware.RequirePermission(authz.PermPlatformAIDiagnosticsExec), memoryHandler.PlatformCreate)
	platformAIGroup.POST("/memories/:id/revoke", normalTimeout, bodyAuth, middleware.RequirePermission(authz.PermPlatformAIDiagnosticsExec), memoryHandler.PlatformRevoke)

...
// Logout clears both cookies and revokes the refresh token through the identity backend.
func (h *AuthHandler) Logout(c *gin.Context) {
	...
	// Attempt to revoke the refresh token on the identity backend; ignore errors because the cookie must be cleared regardless.

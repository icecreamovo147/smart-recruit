...
export const listAgentSkills = async (
  ...
  const res: any = await request.get('/api/v1/hr/admin/agent-skills', {
    params: {
      page: params.page ?? 1,
...
export const previewAgentSkill = async (
  ...
  const res: any = await request.post('/api/v1/hr/admin/agent-skills/preview', data)
...
export const getAgentSkill = async (
  ...
  const res: any = await request.get(`/api/v1/hr/admin/agent-skills/${id}`)
...
export const createAgentSkill = async (
  ...
  const res: any = await request.post('/api/v1/hr/admin/agent-skills', data)
...
export const updateAgentSkill = async (
  ...
  const res: any = await request.put(`/api/v1/hr/admin/agent-skills/${id}`, data)
...
export const updateAgentSkillStatus = async (
  ...
  const res: any = await request.patch(`/api/v1/hr/admin/agent-skills/${id}/status`, data)
...
export const listAgentSkillVersions = async (
  ...
  const res: any = await request.get(`/api/v1/hr/admin/agent-skills/${id}/versions`)
...
export const createAgentSkillVersion = async (
  ...
  const res: any = await request.post(`/api/v1/hr/admin/agent-skills/${id}/versions`, data)
...
export const activateAgentSkillVersion = async (
  ...
  const res: any = await request.post(`/api/v1/hr/admin/agent-skills/${id}/versions/${versionId}/activate`)
...
export const debugSemanticRetrieval = async (
  ...
  const res: any = await request.get('/api/v1/hr/admin/agent-skills/semantic-debug', {
    params: {
      query: params.query,

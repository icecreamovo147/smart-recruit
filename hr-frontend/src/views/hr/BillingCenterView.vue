      ...
      <div class="workspace-surface__body billing-workspace__body">
        <div class="billing-content">
          ...
          <section class="console-card entitlement-card">
            ...
            <div class="entitlement-metrics" aria-label="额度摘要">
              <article class="entitlement-metric"><div class="entitlement-metric__label">可用额度</div><div class="entitlement-metric__value">{{ (account?.available_credits || 0).toLocaleString() }}</div><div class="entitlement-metric__hint">当前可立即使用</div></article>
              <article class="entitlement-metric"><div class="entitlement-metric__label">本期总额度</div><div class="entitlement-metric__value">{{ (account?.total_credits || 0).toLocaleString() }}</div><div class="entitlement-metric__hint">套餐与加量包合计</div></article>
              <article class="entitlement-metric"><div class="entitlement-metric__label">已使用</div><div class="entitlement-metric__value">{{ (account?.used_credits || 0).toLocaleString() }}</div><div class="entitlement-metric__hint">已完成结算的消耗</div></article>
              <article class="entitlement-metric"><div class="entitlement-metric__label">已预占</div><div class="entitlement-metric__value">{{ (account?.reserved_credits || 0).toLocaleString() }}</div><div class="entitlement-metric__hint">执行中的 AI 任务</div></article>
            </div>
          </section>
...
<style scoped>
.billing-page{padding-bottom:0;overflow:hidden}.billing-workspace{height:100%;min-width:0}.billing-workspace__body{min-width:0;padding:0;overflow:auto}.billing-content{min-width:0;display:grid;gap:16px;padding:18px 24px 16px}.billing-content>*{min-width:0}.entitlement-actions{display:flex;align-items:center;gap:8px}.entitlement-card__body{display:grid;grid-template-columns:minmax(260px,.75fr) minmax(360px,1.25fr);gap:32px;align-items:center;padding:22px 24px}.current-plan{display:grid;gap:6px}.current-plan__label{color:var(--text-muted);font-size:12px}.current-plan>strong{color:var(--text-primary);font-size:26px;line-height:1.25}.current-plan p{margin:0;color:var(--text-muted);font-size:13px;line-height:1.6}.usage-overview{display:grid;gap:10px}.usage-overview__head,.usage-overview__meta{display:flex;justify-content:space-between;gap:16px}.usage-overview__head{align-items:end;color:var(--text-muted);font-size:13px}.usage-overview__head strong{color:var(--text-primary);font-size:18px}.usage-overview__meta{color:var(--text-faint);font-size:12px}.entitlement-metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));border-top:1px solid var(--border)}.entitlement-metric{min-width:0;padding:16px 24px}.entitlement-metric+.entitlement-metric{border-left:1px solid var(--border)}.entitlement-metric__label{color:var(--text-muted);font-size:12px;line-height:1.4}.entitlement-metric__value{margin-top:6px;color:var(--text-primary);font-size:22px;font-weight:700;line-height:1}.entitlement-metric__hint{margin-top:6px;color:var(--text-faint);font-size:12px;line-height:1.4}.billing-catalog{min-width:0;overflow:hidden}.billing-catalog__head{border-bottom:0}.billing-tabs{min-width:0;padding:0 18px 18px}.billing-tabs :deep(.el-tabs__header){margin-bottom:18px}.billing-tabs :deep(.el-tabs__content),.billing-tabs :deep(.el-tab-pane){min-width:0;max-width:100%}.product-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:14px}.product-card{display:flex;min-height:205px;min-width:0;flex-direction:column;justify-content:space-between;padding:18px;border:1px solid var(--border);border-radius:10px;background:var(--surface)}.product-card__head h3{margin:8px 0 6px;color:var(--text-primary);font-size:18px}.product-card__head p{margin:0;color:var(--text-muted);font-size:13px;line-height:1.55}.product-card__type{display:inline-flex;padding:3px 8px;border-radius:6px;color:var(--el-color-primary);background:var(--el-color-primary-light-9);font-size:11px;font-weight:600}.product-card__type--pack{color:var(--el-color-success);background:var(--el-color-success-light-9)}.price-row{display:flex;justify-content:space-between;align-items:end;gap:14px;padding-top:16px;border-top:1px solid var(--border)}.price-row>div{display:grid;grid-template-columns:auto auto;align-items:end;gap:2px 5px}.price-row strong{color:var(--text-primary);font-size:23px}.price-row span,.price-row small{color:var(--text-muted)}.price-row small{grid-column:1/-1;font-size:12px}.order-table{width:100%;max-width:100%;border:1px solid var(--border);border-radius:8px}.order-expiry{display:grid;gap:3px}.order-expiry small{color:var(--text-faint);font-size:11px}.table-placeholder{color:var(--text-faint)}@media(max-width:900px){.entitlement-card__body{grid-template-columns:1fr}.entitlement-metrics{grid-template-columns:repeat(2,minmax(0,1fr))}.entitlement-metric:nth-child(odd){border-left:0}.entitlement-metric:nth-child(n+3){border-top:1px solid var(--border)}}@media(max-width:720px){.billing-content{padding:14px 14px 10px}.entitlement-card__body{padding:18px}.usage-overview__meta{flex-direction:column;gap:4px}.entitlement-metrics{grid-template-columns:1fr}.entitlement-metric{padding:14px 18px}.entitlement-metric+.entitlement-metric{border-top:1px solid var(--border);border-left:0}.price-row{align-items:stretch;flex-direction:column}.price-row>div{justify-content:start}}
</style>

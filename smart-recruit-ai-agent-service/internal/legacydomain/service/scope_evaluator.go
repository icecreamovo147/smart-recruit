...
// NewScopeEvaluator builds the shared data-scope evaluator for service roots
// that wire domain services outside this package.
func NewScopeEvaluator(authzRepo *repository.AuthzRepo) *scopeEvaluator {
	return &scopeEvaluator{authzRepo: authzRepo}
}

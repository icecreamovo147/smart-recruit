...
| T004 | Backend API contracts for resume profiles and match evaluations | passed | feature/intelligent-recruiting-agent-upgrade | pending | PASS | 1 | `go test ./service -run 'TestRecruitingIntelligence'` passed; `go test ./...` passed in both Go services | Auto-commit pending. |

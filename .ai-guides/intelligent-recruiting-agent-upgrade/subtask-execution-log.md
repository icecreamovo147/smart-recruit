...
| T008 | HR resume profile and match evaluation views | passed | feature/intelligent-recruiting-agent-upgrade | - | PASS | 1 | `pnpm --filter hr-frontend typecheck` passed; `git diff --check` passed | Rollback point pending commit. |

# Acceptance - TASK-BDME-040

## TASK Summary

Interview Service Skeleton And API Extraction: Create and extract Interview service runtime for schedules, interviewer tasks, feedback, and lifecycle APIs.

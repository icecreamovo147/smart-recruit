# Acceptance - TASK-BDME-031

## TASK Summary

AI Agent Runtime Extraction: Move AI chat, agent runs, provider fallback, and async AI workload execution into AI Agent service runtime.

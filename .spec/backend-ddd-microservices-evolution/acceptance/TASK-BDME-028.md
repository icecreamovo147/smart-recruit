# Acceptance - TASK-BDME-028

## TASK Summary

Notification Service Runtime Extraction: Run Notification persistence, unread counts, email coordination, realtime delivery, and consumers from the Notification service runtime.

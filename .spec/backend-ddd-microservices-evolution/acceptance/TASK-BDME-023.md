# Acceptance - TASK-BDME-023

## TASK Summary

Interview Offer Recruitment Event Decoupling: Replace hidden cross-domain state writes among Recruitment, Interview, and Offer with events, adapters, or process-manager logic.

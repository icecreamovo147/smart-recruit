...
- `ACASE-012` / `CHECK-017`: directly affected active Agent runtime and Gateway knowledge documents describe the non-empty durable Run and Anthropic envelope validation and pass knowledge validation.
